...
export default function Hero() {
  return (
    <section className="HeroSection relative lg:pb-24 pb-14">
      ...
      <div
        className="h-[566px] opacity-50"
        style={{
          backgroundSize: "cover",
          width: "100%",
          background:
            "radial-gradient(75.18% 75.18% at 50% 24.82%, rgba(0, 0, 0, 0) 0%, #1F1B25 100%), url(/images/landingPage/Hero/render_hero.jpg)",
        }}
      />
      <div className="opacity-100 absolute top-0 left-0 w-full h-full flex flex-row items-center justify-center">
