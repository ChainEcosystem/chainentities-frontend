  ...
  return (
    <div className="flex lg:flex-row flex-col lg:gap-7 gap-8 items-center">
      ...
      <div className="flex flex-col w-full">
        <div className="lsmall">{metaDetails.metaverseMap.headline}</div>
        ...
        <div className="xsmall text-blue">{metaDetails.metaverseMap.note}</div>
      </div>
    </div>
  );
};
    ...
    <div className="flex lg:flex-row flex-col lg:gap-7 gap-9 items-center">
      ...
      <div className="flex flex-col w-full">
        <div className="lsmall">
          2D Pixel tickets has certain traits (such as shoes, pants, race,
          gender, etc.) that will be carried in the metaverse to a 3D model in
          the form of the same traits. The 3D in-game models are created in{" "}
          <a
        ...
        <div className="bg-light w-full my-4" style={{ height: "2px" }} />

        <div className="lsmall">
          2D Pixel tickets are access IDs for the metaverse. Every progress in
          the metaverse is stored under the token ID of a specific NFT{" "}
        ...
        <div className="xsmall text-blue">
          *Players can trade their tickets just like they would any virtual
          asset (NFT)
        </div>
      </div>
    </div>
  ...
  return (
    <section className="lg:pb-24 pb-14">
      <div className="wrapper">
        ...
        {/* Desktop version */}
        <div className="lg:block hidden w-full rounded-lg">
          <div className="bg-dark flex lg:flex-row flex-col lg:justify-between justify-center items-center lg:h-28 w-full rounded-t-lg lg:gap-0 gap-4 p-5">
          ...
          <div className="bg-divider p-5 rounded-b-lg">
            {activeTabIndex === 0 && <ContentMap />}
            {activeTabIndex === 1 && <ContentModels />}
          </div>
        </div>
        ...
        <div className="lg:hidden w-full rounded-lg">
          {metaDetails.tabs.map((tab, index) => (
            <>
              ...
              {activeTabIndex === 0 && index === 0 && (
                <div className="bg-divider p-5 rounded-b-lg">
                  <ContentMap />
                </div>
              )}

              {activeTabIndex === 1 && index === 1 && (
                <div className="bg-divider p-5 rounded-b-lg">
                  <ContentModels />
                </div>
              )}
